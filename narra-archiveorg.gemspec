...
require 'narra/archiveorg/version'

Gem::Specification.new do |spec|
  spec.name          = "narra-archiveorg"
  spec.version       = Narra::Archiveorg::VERSION
  spec.authors       = ["Michal Mocnak"]
  spec.email         = ["michal@marigan.net"]
  spec.summary       = %q{NARRA Archive.org Connector}
  spec.description   = %q{NARRA Connector to use sources from Archive.org}
